var curIndex = 0, //当前index
      imgArr = getElementsById("float_photo")[0].getElementsByTagName("li"), //获取图片组
      imgLen = imgArr.length,
      infoArr = getElementsById("infoList")[0].getElementsByTagName("li"), //获取图片info组
      indexArr = getElementsById("float_num")[0].getElementsByTagName("li"); //获取控制index组
     // 定时器自动变换2.5秒每次
 ...
 function addEvent(){
  ...
  function changeTo(num){ 
    //设置image
    var imgList = getElementsById("float_photo")[0];
    ...
    //设置image的控制下标 index
    var _curIndex = getElementsByClassName("float_num")[0];
